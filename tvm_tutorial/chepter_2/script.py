...
tvmc.tune(model, target="llvm") # , tuning_records = "records.log") #Step 1.5: Optional Tune

# Saving the tuning result
tvmc.compile(model, target="llvm", tuning_records = "records.log", package="my_model.tar") #Step 2: Compile
